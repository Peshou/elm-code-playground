...
/***/ function(module, exports) {
	...
	var _Peshou$elm_code_playground$Main$init = {ctor: '_Tuple2', _0: 'Hello', _1: _elm_lang$core$Platform_Cmd$none};
	var _Peshou$elm_code_playground$Main$main = _elm_lang$html$Html$program(
		{init: _Peshou$elm_code_playground$Main$init, view: _Peshou$elm_code_playground$Main$view, update: _Peshou$elm_code_playground$Main$update, subscriptions: _Peshou$elm_code_playground$Main$subscriptions})();
	var _Peshou$elm_code_playground$Main$NoOp = {ctor: 'NoOp'};
